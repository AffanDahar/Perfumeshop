...
Search: {library} documentation llms.txt 2. **Try known llms.txt paths:**

Navigate to `{docs-base-url}/llms.txt`
Navigate to `{docs-base-url}/docs/llms.txt`
Navigate to `{docs-base-url}/llms-full.txt`` 3. **Try .md documentation paths:**

Search: {library} {topic} filetype:md site:github.com
Navigate to `{docs-base-url}/docs/{topic}.md`
Navigate to `{docs-base-url}/{topic}.md` 4. **Final fallback - fetch normal page:**
